...
//	http://localhost[:8080]/{your-app-root}/swagger-ui/index.html
    ...
    private String title = "SSAFY FindHomes API " + version;

    private ApiInfo apiInfo() {
        String descript = "SSAFY FindHomes API Reference for Developers<br>";
...
//				.termsOfServiceUrl("https://edu.ssafy.com")
                .contact(new Contact("SSAFY", "https://edu.ssafy.com", "wlsgh7608@naver.com")).license("Findhomes License")
                .licenseUrl("findhomes@naver.com").version("1.0").build();
    }
